// Code generated by goplus from desktop_view.gp. DO NOT EDIT.
//goplus:v v0.28.0
	...
	return layout.Inset{Left: unit.Dp(24), Right: unit.Dp(24)}.Layout(gtx, func(gtx layout.Context) layout.Dimensions {
		return layout.Flex{Axis: layout.Horizontal, Alignment: layout.Middle}.Layout(gtx,
			...
			layout.Rigid(func(gtx layout.Context) layout.Dimensions {
				...
				if !model.Online || model.Error != "" {
					label.Color = desktopAmber
				} else {
					label.Color = desktopRailText
				}
				return label.Layout(gtx)
			}),
			layout.Rigid(layout.Spacer{Width: unit.Dp(12)}.Layout),
...
func desktopIncidentItem(gtx layout.Context, ui *native.UI[Msg], incident Incident, selected bool) layout.Dimensions {
	...
	if selected {
		background = color.NRGBA{R: 42, G: 63, B: 75, A: 255}
	}
...
func desktopDetail(gtx layout.Context, model Model, ui *native.UI[Msg], list *layout.List) layout.Dimensions {
	...
	if incident, ok := selectedIncident(model); ok {
		widgets = append(widgets,
			...
			func(gtx layout.Context) layout.Dimensions {
				return desktopSectionTitle(gtx, ui, "RESPONSE TASKS", fmt.Sprintf("%d", len(incident.Tasks)))
			},
		)
		...
		widgets = append(widgets,
			...
			func(gtx layout.Context) layout.Dimensions {
				return desktopSectionTitle(gtx, ui, "OPERATIONAL TIMELINE", fmt.Sprintf("%d", len(incident.Timeline)))
			},
		)
	...
	widgets = append(widgets,
		func(gtx layout.Context) layout.Dimensions {
			return desktopSectionTitle(gtx, ui, "OPEN NEW INCIDENT", "")
		},
...
func desktopTimelineItem(gtx layout.Context, ui *native.UI[Msg], event Activity) layout.Dimensions {
	return desktopSurface(gtx, desktopCard, 7, unit.Dp(11), func(gtx layout.Context) layout.Dimensions {
		return layout.Flex{Axis: layout.Horizontal, Alignment: layout.Middle}.Layout(gtx,
			layout.Rigid(func(gtx layout.Context) layout.Dimensions {
				return desktopTextLabel(gtx, ui, event.At, desktopTeal, unit.Sp(12))
			}),
			layout.Rigid(layout.Spacer{Width: unit.Dp(12)}.Layout),
			layout.Rigid(func(gtx layout.Context) layout.Dimensions {
				return desktopTextLabel(gtx, ui, stringsUpper(event.Kind), desktopMuted, unit.Sp(11))
			}),
			layout.Rigid(layout.Spacer{Width: unit.Dp(14)}.Layout),
			layout.Flexed(1, func(gtx layout.Context) layout.Dimensions {
				return desktopTextLabel(gtx, ui, event.Body, desktopText, unit.Sp(13))
			}),
		)
	})
}
...
func desktopSectionTitle(gtx layout.Context, ui *native.UI[Msg], title, count string) layout.Dimensions {
	return layout.Flex{Axis: layout.Horizontal, Alignment: layout.Middle}.Layout(gtx,
		layout.Rigid(func(gtx layout.Context) layout.Dimensions {
			return desktopTextLabel(gtx, ui, title, desktopText, unit.Sp(13))
		}),
		layout.Rigid(layout.Spacer{Width: unit.Dp(8)}.Layout),
		layout.Rigid(func(gtx layout.Context) layout.Dimensions {
			return desktopTextLabel(gtx, ui, count, desktopMuted, unit.Sp(12))
		}),
	)
}
