// Code generated by goplus from logic.gp. DO NOT EDIT.
//goplus:v v0.28.0
...
func LocalSave(model Model) program.Cmd[Msg] {
	return program.After(
		50*time.Millisecond,
		program.Emit[Msg](SaveSucceeded{Tasks: cloneTasks(model.Tasks)}),
	)
}
...
func RemoteSave(model Model) program.Cmd[Msg] {
	...
	return browser.MustRemote(
		...
		func(response SaveResponse) Msg {
			return SaveSucceeded{Tasks: cloneTasks(response.Tasks)}
		},
		func(failure browser.PublicError) Msg {
			return SaveFailed{Message: failure.Message}
		},
	)
}
